...
class EnergySimulation(TimeSeriesData):
    ...
    def __init__(
        self, month: Iterable[int], hour: Iterable[int], day_type: Iterable[int], indoor_dry_bulb_temperature: Iterable[float], non_shiftable_load: Iterable[float],
        non_shiftable_load_predicted_4h: Iterable[float], non_shiftable_load_predicted_6h: Iterable[float],
        non_shiftable_load_predicted_12h: Iterable[float], non_shiftable_load_predicted_24h: Iterable[float],
        dhw_demand: Iterable[float], cooling_demand: Iterable[float], heating_demand: Iterable[float], solar_generation: Iterable[float],
        daylight_savings_status: Iterable[int] = None, average_unmet_cooling_setpoint_difference: Iterable[float] = None,
        indoor_relative_humidity: Iterable[float] = None, occupant_count: Iterable[int] = None,
        indoor_dry_bulb_temperature_set_point: Iterable[int] = None, hvac_mode: Iterable[int] = None, power_outage: Iterable[int] = None,
        comfort_band: Iterable[float] = None, start_time_step: int = None, end_time_step: int = None
    ):
        ...
        self.non_shiftable_load_predicted_4h = np.array(non_shiftable_load_predicted_4h, dtype = 'float32')
        self.non_shiftable_load_predicted_6h = np.array(non_shiftable_load_predicted_6h, dtype = 'float32')
        self.non_shiftable_load_predicted_12h = np.array(non_shiftable_load_predicted_12h, dtype = 'float32')
        self.non_shiftable_load_predicted_24h = np.array(non_shiftable_load_predicted_24h, dtype = 'float32')
...
class Pricing(TimeSeriesData):
    ...
    def __init__(
        ...
        electricity_pricing_predicted_24h: Iterable[float], selling_pricing: Iterable[float], start_time_step: int = None, end_time_step: int = None
    ):
        super().__init__(start_time_step=start_time_step, end_time_step=end_time_step)
        ...
        self.selling_pricing = np.array(selling_pricing, dtype='float32')
