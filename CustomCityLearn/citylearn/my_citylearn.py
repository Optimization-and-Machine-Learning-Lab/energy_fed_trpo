...
import numpy as np
import pandas as pd
from CustomCityLearn.citylearn.my_building import Building
...
from CustomCityLearn.citylearn.my_reward_function import RewardFunction
            ...
            if building_schema['include']:
                ...
                for name in device_metadata:
                    if building_schema.get(name, None) is None:
                        ...
                        constructor = getattr(importlib.import_module(f'CustomCityLearn.{(device_module)}'),device_name)
