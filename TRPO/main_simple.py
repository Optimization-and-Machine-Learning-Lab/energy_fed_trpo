...
if wandb_record:
    ...
    wandb.run.name = "TRPO_RandomBanmaEnv_train_step_1500"
wandb_step = 0
...
parser.add_argument('--batch-size', type=int, default=1500, metavar='N',
                    help='random seed (default: 1)')        # 15000
...
env = RandomBanmaEnv(action_diff_penalty=penalty)
...
for i_episode in count(1):
    ...
    if i_episode % args.log_interval == 0:
        ...
        if wandb_record:
            wandb.log({"eval": reward_sum}, step = wandb_step)
    if i_episode > 1000:
        break
